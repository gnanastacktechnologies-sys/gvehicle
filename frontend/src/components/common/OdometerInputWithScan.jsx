    ...
    <div>
      ...
      <div className="flex items-center space-x-2 w-full max-w-full">
        <input
          ...
          className={`flex-1 min-w-0 px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold text-slate-800 focus:ring-2 focus:ring-indigo-500 focus:outline-hidden ${className}`}
        />
        <button
          type="button"
          ...
          className="px-2.5 sm:px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-semibold flex items-center space-x-1.5 transition-all cursor-pointer flex-shrink-0 disabled:opacity-50 shadow-sm shadow-indigo-100"
        >
          <FaCamera className="w-3.5 h-3.5 text-white flex-shrink-0" />
