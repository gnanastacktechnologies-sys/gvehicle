...
const OdometerScannerModal = ({ isOpen, onClose, onConfirm, initialValue = '' }) => {
  ...
  const startCamera = async () => {
    ...
    try {
      ...
      setError('Could not access camera. You can upload an image of the odometer dashboard instead.');
    }
  };
          ...
          <div className="space-y-3">
            <div className="relative bg-slate-900 rounded-2xl overflow-hidden aspect-v-4/3 flex items-center justify-center border border-slate-800 shadow-inner min-h-[240px]">
              {cameraActive ? (
                <>
                  ...
                  />
                  {/* Alignment guide box */}
                  <div className="absolute inset-x-8 top-1/3 bottom-1/3 border-2 border-dashed border-amber-400/80 rounded-xl flex items-center justify-center bg-amber-400/10 backdrop-blur-[1px]">
                ...
                <div className="text-center p-6 text-slate-400 space-y-2">
                  ...
                  <p className="text-xs font-medium">Camera not active or access denied.</p>
                </div>
              )}
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              >
                ...
                <span>Upload Dashboard Photo</span>
              </button>
              <input
                ref={fileInputRef}
                type="file"
